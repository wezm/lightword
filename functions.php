...
<li class="list <?php if ($comment->comment_author_email == get_the_author_email()) { echo 'author_comment'; } ?>" id="comment-<?php comment_ID() ?>">
<cite>
...
<div class="commenttext clear"><?php comment_text() ?></div>
<?php echo comment_reply_link(array('before' => '<div class="reply">', 'after' => '</div>', 'reply_text' => __('Reply to this comment','lightword'), 'depth' => $depth, 'max_depth' => $args['max_depth'] ));  ?>
<div class="clear"></div>
<?php
}
