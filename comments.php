...
<?php wp_list_comments('type=comment&callback=nested_comments&max_depth=2'); ?>
...
<a name="respond"></a><h2 id="postcomment"><?php _e('Leave a comment','lightword'); ?></h2>
...
<?php else : ?>
<div id="cancel-comment-reply"><?php cancel_comment_reply_link(__('Click here to cancel reply','lightword')) ?></div>
