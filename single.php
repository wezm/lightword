...
<div class="continue"><a class="nr_comm_spot" href="<?php the_permalink(); ?>#respond"><?php comments_number(__('No Comments','lightword'), __('1 Comment','lightword'), __('% Comments','lightword')); ?></a></div><div class="clear"></div></div><div class="cat_tags_close"></div>
